...
\end{equation}
This is the definition of trigonometric functions on $\mathbb{C}$. 
\end{frame}
...
By DeMoivre's formula, $x=(3,40^{\circ})$ is a solution. However,
$c=(27,480^{\circ})$ and therefore, by DeMoivre's formula again,
