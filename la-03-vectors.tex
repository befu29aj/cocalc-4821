...
\begin{frame}
  ...
  \begin{equation}
    ...
    -1.6741+0.89598i\notag
  \end{equation}
  which is clearly a different number. A positive number $r$ in
  $\mathbb{R}$ has two numbers whose square is $r$. We pick the
  positive version to be the square root of $r$. Complex numbers
  (except zero) always have two square roots, the solutions to the
  equation $x^{2}=r$.
\end{frame}
