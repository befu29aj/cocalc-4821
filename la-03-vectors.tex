...
\begin{frame}
  ...
  gives us $x=-46-9i$. If we convert to polar form,
  \begin{equation}
    \label{eq:akingahg}
    x=\left(\sqrt{13}\left(\cos(-56.31^{\circ})+i\sin(-56.31^{\circ})\right)\right)^{3}=\left(\sqrt{13}\left(e^{i\cdot{}(-56.31^{\circ})}\right)\right)^{3}=\sqrt{13}^{\frac{3}{2}}\left(\cos(-168.93^{\circ})+i\sin(-168.93^{\circ})\right)=-46-9i
  \end{equation}
\end{frame}
