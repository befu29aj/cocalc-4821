...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:ohsegeel}
    \left(\sqrt{13}\left(e^{i\cdot{}(-56.31^{\circ})}\right)\right)^{3}=\sqrt{13}^{\frac{3}{2}}\left(\cos(-168.93^{\circ})+i\sin(-168.93^{\circ})\right)=-46-9i\notag
  \end{equation}
  ...
  \begin{equation}
    \label{eq:ohsegeel}
    \left(\sqrt{13}\left(e^{i\cdot{}(-56.31^{\circ})}\right)\right)^{\frac{1}{2}}=13^{\frac{1}{4}}\left(\cos(-28.55^{\circ})+i\sin(-28.55^{\circ})\right)=-46-9i\notag
  \end{equation}
\end{frame}
