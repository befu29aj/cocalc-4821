...
\=a(x-h)^{2}+k\ Are the following three parabolas a basis for this
vector space?
\begin{equation}
  \label{eq:iozooroo}
  \begin{array}{ccccc}
y&=&2(x+6)^{2}&+&1\\y&=&(x+10)^{2}&+&1\\y&=&4(x-2)^{2}&+&1
  \end{array}\notag
\end{equation}
\begin{itemize}
\item If yes, find the coordinates in terms of this basis for \=32(x-33)^{2}+30\
