...
\begin{frame}
  ...
  \begin{equation}
    ...
    Y_{1}=\left(\frac{Y\cdot{}b_{1}}{b_{1}\cdot{}b_{1}}\right)b_{1}=\left[
      ...
      \end{array}\right]
  \end{equation}
  Then the projection $Y_{S}$ equals
  \begin{equation}
    \label{eq:yeeyaesh}
    Y_{1}+Y_{2}+Y_{3}=\left(\frac{Y\cdot{}b_{1}}{b_{1}\cdot{}b_{1}}\right)b_{1}=\left[
      \begin{array}{c}
        79.32242 \\
        0 \\
        0 \\
        -79.32242
      \end{array}\right]+\left(\frac{Y\cdot{}b_{1}}{b_{1}\cdot{}b_{1}}\right)b_{1}=\left[
      \begin{array}{c}
        -14.214 \\
        14.214 \\
        14.214 \\
