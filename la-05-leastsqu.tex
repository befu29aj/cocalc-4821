...
\begin{frame}
  \frametitle{Least Squares Method}
  \beispiel{Angles at Gray Cliff} This example is from Oscar S.
  Adams's \emph{Application of the Theory of Least Squares to the
    Adjustment of Triangulation}. You measure the following angles.
  ...
  \begin{tabular}{|c|c|c|}\hline
    ...
    Tyonek & Round Point & $8^{\circ}39'15.9''$ \\ \hline
