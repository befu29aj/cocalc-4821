...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:weehohqu}
    u_{v}=\left(\frac{u\cdot{}v}{v\cdot{}v}\right)\cdot{}v
  \end{equation}
...
\begin{frame}
  ...
  squared error corresponds to the projection of $Y$ onto $S$.
\end{frame}
...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:aiwaozie}
    C=\frac{B\cdot{}X}{X\cdot{}X}\cdot{}X
  \end{equation}
  Note that $X\perp{}B_{X}$. 
\end{frame}
