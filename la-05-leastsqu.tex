...
\begin{frame}
  ...
  \mbox{Paul R. Wolf's} \emph{Survey Measurement Adjustments by Least
    Squares}. Abigail measures a length $\bar{XY}$ to be 211.52 units.
  Ben measures a length $\bar{YZ}$ to be 220.10 units. Charlie
  measures the length $\bar{XZ}$ to be 431.71 units. What lengths
