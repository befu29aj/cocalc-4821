...
\begin{tabular}{r|l|l}
variable & adjusted & original \\ \hline
      $x$ & $596.33$ & $595.74$ \\ 
      $y$ & $538.53$ & $537.76$ \\ 
      $z$ & $801.25$ & $800.92$ \\ 
      $w$ & $659.00$ & $658.44$ \\ 
...
linearization instead of the non-linear function), we should repeat
the process using the new numbers as we did with Newton's method.
\end{frame}
