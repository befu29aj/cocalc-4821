...
G(x,y,z,w)=\sqrt{(z-x)^{2}+(w-y)^{2}}    
  \end{equation}
is, however, a function from $\mathbb{R}^{4}\rightarrow\mathbb{R}$. We
need to use a generalization of Taylor polynomials for higher
...
\begin{equation}
  ...
  J=\left[\begin{array}{ccc}
     ...
     {\vdots} & {\ddots} & \frac{\partial F_2}{\partial x_n} \\
