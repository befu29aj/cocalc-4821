...
\begin{equation}
  \label{eq:peeyohli}
W=\{c|c:(x-x_{0})^{2}+(y-y_{0})^{2}=r^{2}}  
\end{equation}
Are the following three circles a basis for $W$?
\begin{equation}
  \label{eq:iozooroo}
  \begin{array}{rcl}
...
\end{equation}
\begin{itemize}
\item If yes, find the coordinates in terms of this basis for $c:(x+14)^{2}+(y+9)^{2}=144$.
