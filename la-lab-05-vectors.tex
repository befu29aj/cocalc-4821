...
\begin{equation}
  \label{eq:siechaep}
  S=\{u\in\mathbb{R}^{3}|u\mbox{ corresponds to }\vec{u}=\vec{u_{0}}+s_{1}\vec{v_{1}}+{\ldots}+s_{n}\vec{v_{n}}\}
\end{equation}
...
\begin{equation}
  \label{eq:xoomoube}
  S=\{u\in\mathbb{R}^{4}|u\mbox{ corresponds to }\vec{u}=\vec{u_{0}}+s_{1}\vec{v_{1}}+{\ldots}+s_{n}\vec{v_{n}}\}
\end{equation}
where $n$ is the dimension of the solution space and
$s_{i}\in\mathbb{R}$ for $i=1,{\ldots},n$. Note that
