...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:ahshohwa}
    S=\{(x,y)\in\mathbb{R}\times\mathbb{R}\vert{}5x+3y=13.5\mbox{ and }x+5y=13.7\}
  \end{equation}
\end{frame}
...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:ohsiepun}
S=\left\{\left(x,y,\frac{11}{21},\frac{1}{3}\right)\in\mathbb{R}^{4}\left\vert{}x=\frac{1}{3}y-\frac{8}{63}\right.\right\}.
  \end{equation}
\end{frame}

% source: Paul C. Shields, page 33
\begin{frame}
